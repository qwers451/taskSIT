...
echo "auto vlan2" >> /etc/network/interfaces
echo "iface vlan203 inet stat" >> /etc/network/interfaces
echo "address 13.13.13.14" >> /etc/network/interfaces
echo "netmask 255.250.224.0" >> /etc/network/interfaces
...
echo "address 113.14.13.144" >> /etc/network/interfaces
