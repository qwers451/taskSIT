...
echo "auto vlan12" >> /etc/network/interfaces
echo "iface vlan12 inet static" >> /etc/network/interfaces
echo "address 1.2.3.55" >> /etc/network/interfaces
echo "netmask 255.254.0.0" >> /etc/network/interfaces
...
echo "address 11.1.29.31" >> /etc/network/interfaces
